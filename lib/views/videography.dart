...
class _VideographyState extends State<Videography> with OrientationMixin {
  ...
  Future<void> _onRefresh() async {
    setState(() {
      _isLoading = true;
      getCategory(
          "${AppConstant.BASE_URL}/cities/${widget.id}/images/videos/?limit=6");
    });
  }
            ...
            child: SingleChildScrollView(
                ...
                child: Column(children: <Widget>[
                            ...
                            child: Column(
                              children: <Widget>[
                                SizedBox(
                                    ...
                                    height: 150,
                                    child: Text(
                                      "Eclectic Street View Videos of $country",
                  ...
                  Padding(
                    ...
                    child: Text(
                      'Explore $country through diverse videos',
                      style: const TextStyle(
