...
import 'package:kofyimages/views/widgets/commentCard.dart';
...
class _CommentsState extends State<Comments> with OrientationMixin {
  ...
  getdata() async {
    ...
    var id = sharedPreferences.getString("videoID");
    getComments("${AppConstant.BASE_URL}/exhibitions/$id/comments/");
  }
      ...
      body: SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
          ...
          Padding(
              ...
              child: Container(
                height: selectedImagePath == '' ? 400 : 550,
                width: 400,
                decoration: BoxDecoration(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    try {
                      return CommentCard(
                          ...
                          exhibition: cateList[index]['exhibition'],
  ...
  void postDataWithImage() async {
    const url =
        "${AppConstant.BASE_URL}/comments/"; // Replace with your actual endpoint URL

    SharedPreferences Authprefs = await SharedPreferences.getInstance();
    var request = http.MultipartRequest('POST', Uri.parse(url));
    request.headers['Authorization'] = Authprefs.getString("token").toString();

    request.fields['exhibition'] = widget.id.toString();
  ...
  Future<void> submitComment() async {
    try {
      ...
      http.Response response = await http
          .post(Uri.parse('${AppConstant.BASE_URL}/comments/'), headers: {
        'Authorization': Authprefs.getString("token").toString(),
      }, body: {
        "exhibition": widget.id.toString(),
