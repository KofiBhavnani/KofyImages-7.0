...
class _UpdateEventState extends State<UpdateEvent> with OrientationMixin {
  bool showbtn = false;
  ...
  void initState() {
    ...
    eventcityController.text= widget.city;
    eventcountryController.text = widget.country;
    eventlocController.text = widget.location;
    eventdescController.text = widget.description;
    _id= widget.id;
    super.initState();
  }
                        ...
                        GestureDetector(
                            ...
                            onTap: () async {
                              ...
                              if (eventcityController.text.isEmpty) {
                                ...
                                // print(eventcityController.text);
                                // print(eventcountryController.text);
                                // print(eventlocController.text);
                                // print(eventdateController.text);
                                // print(eventtimeController.text);
                                // print(selectedImagePath);
  ...
  void postData() async {
  final url = "${AppConstant.BASE_URL}/events/${widget.id}/"; // Replace with your actual endpoint URL
  ...
  log(data);
     ...
     if (response.statusCode == 200) {
      ...
      }else if (response.statusCode == 401 && data == '{"message":"You are not allowed to update this event"}' ) {
        setState(() {
          showProgressDialog(context, false);
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => const UpComingEvents()));
        ...
        setState(() {
          ...
          const snackdemo = SnackBar(
            content: Text(
              "Could not Update Upcoming Event. Kindly try again!",
              style: TextStyle(
                fontSize: 18.0,
                fontFamily: "Montserrat",
                fontWeight: FontWeight.w500,
